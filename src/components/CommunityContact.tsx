...
const CommunityContact = () => {
  ...
  return (
    <section
      ...
      className="pt-0 pb-16 bg-secondary-paper"
    >
              ...
              <div className="w-full sm:w-[420px] relative mb-8">
                ...
                <div className="flex flex-col items-center w-full">
                  ...
                  <div className="flex items-center justify-center mt-2">
                    {isSearching && (
                      <Loader2
                        className="animate-spin text-accent-coralDeep"
                        size={25}
                      />
                    )}
                  </div>
                ...
                <div className="w-full sm:w-[420px] min-h-[80px] mt-1 p-6 bg-white border border-gray-300 rounded-lg shadow-md">
                  <AnimatePresence mode="wait">
                    {selectedItem ? (
                      ...
                      >
                        <div>
                          <p className="text-accent-coralDeep uppercase text-xs font-bold">
                            First Name
                          </p>
