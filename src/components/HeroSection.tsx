        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          >
            ...
            <p className="text-[15px] text-[hsl(var(--muted))] leading-[1.7] mb-7 max-w-lg">
              Free, expert guidance for families navigating senior care in
              Portland. We do the research, scheduling, and comparison — you
              make the final call.
            </p>
          ...
          >
            {features.map((feature) => (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-[10px] ${feature.iconBg} flex items-center justify-center shrink-0`}
                >
