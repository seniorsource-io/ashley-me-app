    ...
    .aggregate([
      ...
      { $limit: 5 },
      {
        $project: {
          ...
          has_medicaid_contract: 1,
          medicaid_spend_down: 1,
          monthly_base_price: 1,
          monthly_high_price: 1,
          care_services: 1,
          community_rating: 1,
          community_rating_reason: 1,
          community_narrative: 1,
          title: 1,
          website: 1,
          description: 1,
          images: 1,
...
export async function updateCommunity(
  _id: string,
  data: { sms_opt_in: boolean; [key: string]: any },
) {
  try {
    const client = await clientPromise;
